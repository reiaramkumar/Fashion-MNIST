...
path_to_rvm = os.path.join(os.getcwd(), "scikit-rvm-master")
subprocess.check_call([sys.executable, "-m", "pip", "install", path_to_rvm])
...
def save_rvm(save_dir=None):
    ...
    print(df[['name', 'kernel', 'n_iter', 'tol', 'degree', 'num_batches',
          'train_size', 'test_acc', 'macro_f1', 'train_time']
